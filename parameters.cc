...
namespace aspect
{
  ...
  declare_parameters (ParameterHandler &prm)
  {
    ...
    prm.enter_subsection ("Mesh refinement");
    {
      ...
      prm.declare_entry ("Initial regional refinement", "3",
                         Patterns::Integer (0),
                         "The number of regional refinement steps performed on "
                         "the initial coarse mesh, before the problem is first "
                         "solved there.");
      prm.declare_entry ("Initial subregional refinement", "3",
                         Patterns::Integer (0),
                         "The number of subregional refinement steps performed on "
                         "the initial coarse mesh, before the problem is first "
                         "solved there.");
      prm.declare_entry ("Minimum theta", "0",
                         Patterns::Double(0.),
                         "The upper bound of the region of interest.");
      prm.declare_entry ("Maximum theta", "0",
                         Patterns::Double(0.),
                         "The lower bound of the region of interest.");
      prm.declare_entry ("Minimum phi", "0",
                         Patterns::Double(),
                         "The western bound of the region of interest.");
      prm.declare_entry ("Maximum phi", "0",
                         Patterns::Double(),
                         "The eastern bound of the region of interest.");
      prm.declare_entry ("Minimum theta sub", "0",
                         Patterns::Double(0.),
                         "The upper bound of the subregion of interest.");
      prm.declare_entry ("Maximum theta sub", "0",
                         Patterns::Double(0.),
                         "The lower bound of the subregion of interest.");
      prm.declare_entry ("Minimum phi sub", "0",
                         Patterns::Double(),
                         "The western bound of the subregion of interest.");
      prm.declare_entry ("Maximum phi sub", "0",
                         Patterns::Double(),
                         "The eastern bound of the subregion of interest.");
                    ...
                    const MPI_Comm mpi_communicator)
  {
    ...
    prm.enter_subsection ("Mesh refinement");
    {
      ...
      initial_regional_refinement  = prm.get_integer ("Initial regional refinement");
      initial_subregional_refinement  = prm.get_integer ("Initial subregional refinement");
      min_theta                    = prm.get_double ("Minimum theta");
      max_theta                    = prm.get_double ("Maximum theta");
      min_phi                      = prm.get_double ("Minimum phi");
      max_phi                      = prm.get_double ("Maximum phi");
      min_theta_sub                    = prm.get_double ("Minimum theta sub");
      max_theta_sub                    = prm.get_double ("Maximum theta sub");
      min_phi_sub                      = prm.get_double ("Minimum phi sub");
      max_phi_sub                      = prm.get_double ("Maximum phi sub");
